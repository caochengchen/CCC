...
def main():
    ...
    indices_file = '/mnt/sda/caochengcheng/一条龙/演示/1-VQVAE2014T/单步生成对比-test_codebook_indices_generated.txt'
    output_file = '/mnt/sda/caochengcheng/一条龙/演示/1-VQVAE2014T/单步生成对比-test_codebook_indices_decoder.txt'
...
if __name__ == "__main__":
    # 处理预测数据
    pred_filename = "/mnt/sda/caochengcheng/一条龙/演示/1-VQVAE2014T/单步生成对比-test_codebook_indices_decoder.txt"
    ...
    # 处理真实数据
    real_filename = "/mnt/sda/caochengcheng/一条龙/演示/4-可视化/单步真实值-test_whole_body_downsampled_data.txt"
    real_output_prefix = "/mnt/sda/caochengcheng/一条龙/演示/自回归生成阶段输出可视化/单步真实图片/"
...
# 定义路径
original_base_path = '/mnt/sda/caochengcheng/一条龙/演示/自回归生成阶段输出可视化/单步真实图片/'
generated_base_path = '/mnt/sda/caochengcheng/一条龙/演示/自回归生成阶段输出可视化/单步生成图片/'
output_base_path = '/mnt/sda/caochengcheng/一条龙/演示/自回归生成阶段输出可视化/单步生成视频/'
